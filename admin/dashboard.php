...
?>
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<?php
				$start_date = (date("Y")-1).'-'.(date("m")+1 < 10 ? '0'.(date("m")+1) : date("m")+1).'-01 00:00:00';  
				$end_date = date("Y").'-'.date("m").'-'.(date("d")+1 < 10 ? '0'.(date("d")) : date("d")).' 23:59:59';  
				...
				while($row = mysqli_fetch_array($query)){
					...
					//Tháng 1
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-01-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-01-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-01-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-01-31 23:59:59')))
						$listMonth[0] += (int) $row['total_price_map'];
					//Tháng 2
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-02-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-02-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-02-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-02-31 23:59:59')))
						$listMonth[1] += (int) $row['total_price_map'];	
					//Tháng 3
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-03-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-03-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-03-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-03-31 23:59:59')))
						$listMonth[2] += (int) $row['total_price_map'];	
					//Tháng 4
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-04-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-04-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-04-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-04-31 23:59:59')))
						$listMonth[3] += (int) $row['total_price_map'];	
					//Tháng 5
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-05-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-05-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-05-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-05-31 23:59:59')))
						$listMonth[4] += (int) $row['total_price_map'];	
					//Tháng 6
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-06-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-06-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-06-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-06-31 23:59:59')))
						$listMonth[5] += (int) $row['total_price_map'];	
					//Tháng 7
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-07-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-07-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-07-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-07-31 23:59:59')))
						$listMonth[6] += (int) $row['total_price_map'];	
					//Tháng 8
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-08-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-08-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-08-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-08-31 23:59:59')))
						$listMonth[7] += (int) $row['total_price_map'];	
					//Tháng 9
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-09-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-09-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-09-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-09-31 23:59:59')))
						$listMonth[8] += (int) $row['total_price_map'];	
					//Tháng 10
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-10-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-10-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-10-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-10-31 23:59:59')))
						$listMonth[9] += (int) $row['total_price_map'];	
					//Tháng 11
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-11-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-11-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-11-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-11-31 23:59:59')))
						$listMonth[10] += (int) $row['total_price_map'];
					//Tháng 12
					if((strtotime($row['created_at']) >= strtotime(date("Y").'-12-01 00:00:00') && strtotime($row['created_at']) <= strtotime(date("Y").'-12-31 23:59:59')) || (strtotime($row['created_at']) >= strtotime((date("Y")-1).'-12-01 00:00:00') && strtotime($row['created_at']) <= strtotime((date("Y")-1).'-12-31 23:59:59')))
			...
			<div class="col-xs-12" id="info-box" style="margin-bottom: 15px">
				<div class="info-box-content">
					<div class="info-box-item">
						<div class="title color-blue">Doanh thu theo ngày hôm nay</div>
					...
					<div class="info-box-item">
						<div class="title color-red">Doanh thu theo tuần hiện tại</div>
					...
					<div class="info-box-item">
						<div class="title color-yellow">Doanh thu theo tháng hiện tại</div>
			...
			<div class="col-xs-12" id="info-box">
				<div class="info-box-content">
					<div class="info-box-item">
						<div class="title color-blue">Lãi theo ngày hôm nay</div>
					...
					<div class="info-box-item">
						<div class="title color-red">Lãi theo tuần hiện tại</div>
					...
					<div class="info-box-item">
						<div class="title color-yellow">Lãi theo tháng hiện tại</div>
...
Highcharts.chart('container', {
    ...
    xAxis: {
        categories: [
			<?php
				if((int)date("m") != 12) {
					for($i = (int)date("m") + 1; $i <= 12;$i++) {
						echo '\'Tháng'.($i).'/'.((int)date("Y") - 1).'\','; 
					} 
					for($i = 1; $i <= (int)date("m");$i++) {
						echo '\'Tháng'.($i).'/'.((int)date("Y")).'\','; 
					} 
				} else {
    ...
    series: [{
        name: 'Doanh thu',
        // data: [<?php for($i = 0; $i < 12;$i++) { echo $listMonth[$i].','; } ?>]
        data: [<?php 
			if((int)date("m") != 12) {
				for($i = (int)date("m") + 1; $i <= 12;$i++) {
					echo $listMonth[$i-1].',';
...
Highcharts.chart('container1', {
    ...
    title: {
        text: 'Thống kê doanh thu theo danh mục 12 tháng gần nhất'
    },
    xAxis: {
        categories: [
			<?php 
